...
//   const [packages, setPackages] = useState(['pytest', 'httpx']);  // Modified packages list
...
//         const response = await fetch(`https://api.allorigins.win/get?url=https://pypistats.org/api/packages/pytest/overall`);
...
//         console.log(data)
//         // console.log()
//         // Grouping the data by date and aggregating the downloads for the past month
...
//     setPackageData(results.filter(result => result !== null));
//   };
